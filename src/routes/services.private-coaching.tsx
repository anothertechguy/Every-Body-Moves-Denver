...
export const Route = createFileRoute("/services/private-coaching")({
  head: () => ({
    meta: [
      { title: "Private & In-Home Coaching — EBM Colorado" },
...
const perks = [
  { icon: Home, title: "Your Space", body: "Living room, backyard, garage gym — we bring everything we need." },
  { icon: Calendar, title: "Your Schedule", body: "Early mornings, lunch breaks, weekends — flexible around real life." },
  { icon: Target, title: "Your Goals", body: "From returning after injury to your first 5K — a plan that fits you." },
  { icon: HeartPulse, title: "Your Pace", body: "Sustainable, gentle progress — never a program you dread." },
];
  ...
  return (
    <div>
      <section className="relative overflow-hidden hero-surface">
        <div className="blob w-[420px] h-[420px] bg-terracotta/40 -left-24 top-10 float-slower" />
        <div className="blob w-[380px] h-[380px] bg-sage/50 right-0 bottom-0 float-slow" />
        <div className="mx-auto max-w-7xl px-5 lg:px-8 pt-20 pb-24 relative">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6">
              <Reveal>
                <div className="text-sm uppercase tracking-[0.22em] text-terracotta font-semibold">1-on-1 Coaching</div>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <Link to="/contact" className="btn-primary">Book a consultation <ArrowRight className="h-4 w-4" /></Link>
            ...
            <div className="lg:col-span-6">
              <Parallax speed={0.08}>
                <div className="relative">
                  <div className="absolute -inset-6 bg-gradient-to-tr from-terracotta/40 to-butter/60 rounded-[3rem] blur-2xl -z-10" />
                  <img src={privateImg} alt="Trainer coaching a client at home with dumbbells"
            ...
            {perks.map((p, i) => (
              <Reveal key={p.title} delay={i * 90}>
                <div className="soft-card p-7 h-full transition-transform hover:-translate-y-2 duration-500">
                  <div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-terracotta to-coral flex items-center justify-center text-cream">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <Reveal>
              <div className="soft-card p-10 h-full">
                <div className="font-display text-3xl text-sage-deep">Who it's for</div>
            ...
            <Reveal delay={120}>
              <div className="soft-card p-10 h-full">
                <div className="font-display text-3xl text-sage-deep">How it works</div>
                <ol className="mt-6 space-y-5">
                  {[
                    ["01", "Free consultation", "A friendly call to understand your goals, space, and schedule."],
                    ["02", "Custom plan", "We design a program tailored to your body, your equipment, and your life."],
                    ["03", "We show up", "Weekly sessions at your home — everything we need comes with us."],
                    ["04", "Progress that lasts", "Regular check-ins and program updates as you grow stronger."],
                  ].map(([n, t, d]) => (
                    <li key={n} className="flex gap-4">
                      <div className="font-display text-2xl text-coral shrink-0 w-10">{n}</div>
                      <div>
                        <div className="font-semibold text-sage-deep">{t}</div>
